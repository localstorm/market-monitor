...
public class GFSourceOEX implements Source {
    ...
    public BigDecimal getCurrent() throws IOException {
        Document doc = Jsoup.parse(new URL("https://www.google.com/finance?q=INDEXCBOE%3AOEX"), 10000);
        Elements elements = doc.getElementsByAttributeValue("id", "ref_1000736529757159_l");
        if (elements.isEmpty()) {
